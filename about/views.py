...
def renderFAQPage(request):
    ...
    context = {'faq_details_five': faq_details_five,
               'faq_details_last_six': faq_details_last_six,'page_title':title,
                'description':desc,
                'keyword':key,
                'canonical':canonical}
...
def refund_policy(request):
    ...
    context = {'policy': policies.refund_policy,'name':'Refund Policy','page_title':title,
                'description':desc,
                'keyword':key,
                'canonical':canonical}
...
def return_policy(request):
    ...
    context = {'policy': policies.return_policy,'name':'Return Policy','page_title':title,
                'description':desc,
                'keyword':key,
                'canonical':canonical}
    return render(request, 'policies/policy.html', context)
...
def privacy_policy(request):
    ...
    context = {'policy': policies.privacy_policy,'name':'Privacy Policy','page_title':title,
                'description':desc,
                'keyword':key,
                'canonical':canonical}
    return render(request, 'policies/policy.html', context)
...
def shipping_and_delivery_policy(request):
    ...
    context = {'policy': policies.shipping_and_delivery_policy,'name':'Shipping Policy','page_title':title,
                'description':desc,
                'keyword':key,
                'canonical':canonical}
    return render(request, 'policies/policy.html', context)
...
def terms_of_service_policy(request):
    ...
    context = {'policy': policies.terms_of_use,'name':'Terms of Use','page_title':title,
                'description':desc,
                'keyword':key,
                'canonical':canonical}
    return render(request, 'policies/policy.html', context)
...
def payment_terms_and_conditions_policy(request):
    ...
    context = {'policy': policies.payment_type,'name':'Payment Terms and Conditions Policy','page_title':title,
                'description':desc,
                'keyword':key,
                'canonical':canonical}
    return render(request, 'policies/policy.html', context)
