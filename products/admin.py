...
class ProductsAdmin(admin.ModelAdmin):
    list_display: list = ('name','unit','max_retail_price','created_at','modified_at')
    ordering: list = ['-modified_at']
    search_fields: list = ('name','material_feature','max_retail_price','category')
...
class ProductImagesAdmin(admin.ModelAdmin):
    list_display: list = ('product','images')
