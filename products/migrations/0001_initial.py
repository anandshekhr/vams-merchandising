    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner_product_category', models.CharField(blank=True, choices=[('new-arrival', 'New Arrival'), ('best-seller', 'Best Seller'), ('trending', 'Trend Products'), ('Featured Products', 'Featured Products'), ('kids-collection', 'Kids Collection'), ('hot-collection', 'Hot Collection'), ('men-collection', 'Men Collection'), ('women-collection', 'Women Collection'), ('alto-collection', 'Alto Collection')], max_length=50, null=True, verbose_name='Banner Product Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', products.models.ModifiedArrayField(base_field=models.CharField(blank=True, choices=[('new-arrival', 'New Arrival'), ('best-seller', 'Best Seller'), ('trending', 'Trend Products'), ('Featured Products', 'Featured Products'), ('kids-collection', 'Kids Collection'), ('hot-collection', 'Hot Collection'), ('men-collection', 'Men Collection'), ('women-collection', 'Women Collection'), ('alto-collection', 'Alto Collection')], max_length=255, null=True, verbose_name='Product Category'), null=True, size=None)),
                ...
                ('available_sizes', products.models.ModifiedArrayField(base_field=models.CharField(blank=True, choices=[('XS', 'XS'), ('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'XL'), ('XXL', 'XXL'), ('XXXL', 'XXXL'), ('6', '6'), ('7', '7'), ('8', '8'), ('9', '9'), ('10', '10'), ('11', '11'), ('12', '12'), ('13', '13'), ('Double, King', 'Double, King'), ('Double, Queen', 'Double, Queen'), ('Single', 'Single'), ('free-size', 'Free Size')], max_length=255, null=True, verbose_name='Product Available'), null=True, size=None)),
