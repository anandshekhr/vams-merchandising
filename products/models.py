...
CATEGORIES = (('Deal of the day', 'Deal of the day'), ('Best Products', 'Best Products'), ('Trend Products', 'Trend Products'), ('Featured Products', 'Featured Products'), ('Biscuits & Snacks', 'Biscuits & Snacks'), ('Bread & Bakery', 'Bread & Bakery'), ('Breakfast & Dairy', 'Breakfast & Dairy'), ('Frozen Foods', 'Frozen Foods'), ('Fruits & Vegetables','Fruits & Vegetables'), ('Grocery & Staples', 'Grocery & Staples'), ('Household Needs', 'Household Needs'), ('Meats & Seafood', 'Meats & Seafood'), ('Eggs Substitutes', 'Eggs Substitutes'), ('Honey Vegetables', 'Honey Vegetables'), ('Marmalades Staples', 'Marmalades Staples'), ('Sour Cream and Dips', 'Sour Cream and Dips'), ('Yogurt Seafood', 'Yogurt Seafood'),)
...
class Products(models.Model):
    ...
    longname = models.CharField(max_length=1000,default="",null=True,blank=True)
    ...
    tags = ModifiedArrayField(models.CharField(_("Tags"), max_length=50,choices=TAGS,null=True,blank=True),null=True)
    ...
    def list_price(self):
        listprice = self.max_retail_price - ((self.discount/100)*self.max_retail_price)
        return listprice
...
class ProductReviewAndRatings(models.Model):
    product = models.ForeignKey("products", verbose_name=_("product rating"), on_delete=models.CASCADE,null=False,blank=False,default="")
    ...
    ratings = models.IntegerField(_("Product Rating"),choices=RATINGS,null=True)
    upload_image = models.ImageField(_("ImagesForReview"),upload_to="product/media/reviews/%Y/%m/%d", height_field=None, width_field=None, max_length=None,null=True)
...
class Banners(models.Model):
    ...
    BannerPosition = (("Home Page","HOME PAGE"),('Categories Page','CATEGORIES PAGE'),('Product Page','PRODUCT PAGE'),('Top','TOP'),('Middle','MIDDLE'),('Bottom','BOTTOM'),('Right','RIGHT'),('Left','LEFT'))
    ...
    banner_name = models.CharField(_("Banner Name"), max_length=50,null=True,blank=True)
