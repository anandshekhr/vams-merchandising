...
urlpatterns = [
     ...
     path("payment/instamojo/checkout/<float:amount>",orderPaymentRequest,name="paymentcheckout"),
     
     path('payment/razorpay/success/',razorpay_success_redirect,name="razorpay-payment-success"),
     path("payment/instamojo/success/",paymentStatusAndOrderStatusUpdate,name="paymentstatusupdate"),
